/**
 * Welcome Screen Premium - Phase 1 Foundation
 * Version ultra-attractive avec animations et glassmorphism
 */
...
const WelcomeScreenPremium: React.FC = () => {
  ...
  const handleDiceyTap = () => {
    ...
    // Ici on pourrait ajouter une animation spéciale ou un Easter egg
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <DiceyMascot size={140} onTap={handleDiceyTap} />
        </Animated.View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.background }]}>
            ...
            <Text style={[styles.modalText, { color: theme.text.secondary }]}>
              Yams Score - Version Premium{'\n'}
              La meilleure façon de jouer au Yams !
            </Text>
            <TouchableOpacity
              style={styles.modalButton}
              onPress={() => setState(prev => ({ ...prev, showModal: false }))}
            >
...
export default WelcomeScreenPremium;
